...
The "Download extension" button on the page links to the latest
GitHub Release of *this* repository:

```
https://github.com/tanesoff/Diplomska-landingpage/releases/latest
```

When a new version of the extension is ready:

1. Build the extension and zip the `dist/` folder into
   `finki-ai-assistant.zip`
2. Create a new release on this repo with that asset attached:
   `gh release create vX.Y finki-ai-assistant.zip`
3. The "latest" link on the page picks up the new release
